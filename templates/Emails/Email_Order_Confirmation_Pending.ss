<table width="700" cellpadding="10" cellspacing="0" border="0" style="border: 1px solid; border-color: #ccc;">
	...
	<tbody>
		...
		<tr style="font-weight: bold; background-color: #000; color: #fff; text-transform: uppercase;">
			<td colspan="7">$StoreName | Order currently pending</td>
		</tr>
		...
		<tr>
			<td colspan="7">
				...
				We've received your order (#$Order.ID) but are currently waiting on your chosen payment method to
				let us know that your payment has been successful and will follow up with another email	once we hear
				from them. In the meantime, however, you can track your order status online by 
